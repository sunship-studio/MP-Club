...
import 'package:mpc_admin_app/core/widgets/browse_file.dart';
import 'package:mpc_admin_app/core/widgets/chat/divider.dart';
import 'package:mpc_admin_app/core/widgets/chat/header.dart';
import 'package:mpc_admin_app/core/widgets/chat/message.dart';
...
class _ChatScreenState extends State<ChatScreen> with WidgetsBindingObserver {
  ...
  void _initializeChat() async {
    await _socketService.connect('http://192.168.11.70:3500', admin_key);
  }
            ...
            children: [
              GestureDetector(
                onTap: () async {
                  ...
                  if (selectedFile != null) _setSelectedFile(selectedFile);
                },
                child: Container(
                  padding: EdgeInsets.all(8.w),
                  child: Icon(
